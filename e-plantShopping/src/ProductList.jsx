                        ...
                        <a href="#" onClick={handleCartClick} className="cart-link">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="40" width="40">
                                ...
                                <path d="M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8" 
                                      fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
                                </path>
                            </svg>
                            {totalCartItems > 0 && (
            ...
            {showCart ? (
                ...
                <div className="product-grid">
                    <div className="plantname_heading">
                        <h1 className="plant_heading">Our Plant Collection</h1>
                    </div>
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div key={plantIndex} className="product-card">
                                        ...
                                        <img 
                                            ...
                                            alt={plant.name}
                                            onError={(e) => {
                                                e.target.src = 'https://via.placeholder.com/200x200?text=Plant+Image';
                                            }}
                                        />
                ...
                <div className="welcome-message">
                    ...
                    <p>Click on "Plants" to explore our collection.</p>
                </div>
            )}
        </div>
    );
